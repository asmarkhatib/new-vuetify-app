...
export default {
  ...
  methods: {
    alertButton() {
      alert("Hi My Name Is Khatib");
    },
    getInput(event) {
      this.outPut = event.target.value;
    },
    confirmedInput() {
      this.afterEnter = this.outPut;
    },
  },
};
</script>
