<template>
  <div>
    ...
    <section id="assignment">
      ...
      <p :class="tobeChange">Style me!</p>
      <button @click="changeStyle">Toggle Paragraph</button>
      ...
      <input type="text" v-model="userBack" />
      <p :style="{backgroundColor: userBack}">Style me inline!</p>
    </section>
  </div>
</template>
<script>
  ...
  computed: {
    tobeChange() {
      return {
        ...
        visible: this.toggle === true,
        hidden: this.toggle === false,
      };
    },
  },
  methods: {
